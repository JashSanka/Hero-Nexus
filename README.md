...
- Sort results by name or power-related stats
- Responsive design for mobile, tablet, and desktop
- Character details page


## Project Scope
This project focuses on building a clean, interactive and Nerdy superhero explorer web application with API-based data. 
...
## Future Improvements
- Add 3D character animations
- power showcase for characters
- Add transitions 
- Expand filtering and categorization options
